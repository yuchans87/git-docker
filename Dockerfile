...
RUN yum -y update
RUN yum -y install vim nginx git php55-cli php55-common php55-fpm php55-gd php55-intl php55-mbstring php55-mcrypt php55-mysqlnd php55-pdo php55-pecl-http php55-pecl-jsonc php55-pecl-oauth php55-xml php55-xmlrpc php55-opcache
